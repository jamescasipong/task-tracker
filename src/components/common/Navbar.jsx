    ...
    <nav className="bg-gray-800 p-4 w-full relative">
      <div className="container mx-[100px] flex justify-between items-center">
        ...
        <div className="absolute right-[7%] flex gap-5">
          <button onClick={() => {window.location.href = "/instruction.html"}} className="sm:flex hidden items-center bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600 transition-colors duration-300 ease-in-out gap-2">
